...
function pickSubject() {
  const audioLink = `./audio/n3/${activeSubject}/`;
  const audioArr = [
    `3${activeSubject}11.MP3`,
    `3${activeSubject}12.MP3`,
    `3${activeSubject}13.MP3`,
    `3${activeSubject}14.MP3`,
    `3${activeSubject}15.MP3`,
    `3${activeSubject}16.MP3`,
    `3${activeSubject}21.MP3`,
    `3${activeSubject}22.MP3`,
    `3${activeSubject}23.MP3`,
    `3${activeSubject}24.MP3`,
    `3${activeSubject}25.MP3`,
    `3${activeSubject}26.MP3`,
    `3${activeSubject}31.MP3`,
    `3${activeSubject}32.MP3`,
    `3${activeSubject}33.MP3`,
  ];
  const scriptArr = [
    `3${activeSubject}11.txt`,
    `3${activeSubject}12.txt`,
    `3${activeSubject}13.txt`,
    `3${activeSubject}14.txt`,
    `3${activeSubject}15.txt`,
    `3${activeSubject}16.txt`,
    `3${activeSubject}21.txt`,
    `3${activeSubject}22.txt`,
    `3${activeSubject}23.txt`,
    `3${activeSubject}24.txt`,
    `3${activeSubject}25.txt`,
    `3${activeSubject}26.txt`,
    `3${activeSubject}31.txt`,
    `3${activeSubject}32.txt`,
    `3${activeSubject}33.txt`,
  ];
